...
Gem::Specification.new do |s|
  ...
  s.date = "2019-01-07"
  s.description = "A convenience gem for cycling through a set of values, ported from the 'cycle'\n     functionality found in Rails. It is independent of which framework you use so will run in Sinatra,\n     Padrino or straight up Ruby itself.".freeze
